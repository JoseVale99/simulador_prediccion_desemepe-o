...
class Ui_insertar(object):
    def setupUi(self, Form):
        ...
        self.text_act1_2 = QtWidgets.QLineEdit(self.frame_15)
        self.text_act1_2.setObjectName("text_act1_2")
        self.verticalLayout_12.addWidget(self.text_act1_2)
        self.text_act2_2 = QtWidgets.QLineEdit(self.frame_15)
        self.text_act2_2.setObjectName("text_act2_2")
        self.verticalLayout_12.addWidget(self.text_act2_2)
        self.text_act3_2 = QtWidgets.QLineEdit(self.frame_15)
        self.text_act3_2.setObjectName("text_act3_2")
        self.verticalLayout_12.addWidget(self.text_act3_2)
        ...
        self.text_act4_2 = QtWidgets.QLineEdit(self.frame_17)
        self.text_act4_2.setObjectName("text_act4_2")
        self.verticalLayout_14.addWidget(self.text_act4_2)
        self.text_act5_2 = QtWidgets.QLineEdit(self.frame_17)
        self.text_act5_2.setObjectName("text_act5_2")
        self.verticalLayout_14.addWidget(self.text_act5_2)
        self.text_act6_2 = QtWidgets.QLineEdit(self.frame_17)
        self.text_act6_2.setObjectName("text_act6_2")
        self.verticalLayout_14.addWidget(self.text_act6_2)
    ...
    def retranslateUi(self, Form):
        ...
        self.lineEdit_4.setPlaceholderText(_translate("Form", "Ingrese \"SI\" o \"NO\""))
